...
def _symmetric_kl(attention_map1, attention_map2):
    ...
    # attention_map1 = attention_map1 / torch.sum(attention_map1)
    attention_map1 = torch.clamp(attention_map1, min=0)
    attention_map1 = attention_map1 / torch.sum(attention_map1)
    p = dist.Categorical(probs=attention_map1)

    # attention_map2 = attention_map2 / torch.sum(attention_map2)
    # print((attention_map2))
    attention_map2 = torch.clamp(attention_map2, min=0)
    attention_map2 = attention_map2 / torch.sum(attention_map2)
